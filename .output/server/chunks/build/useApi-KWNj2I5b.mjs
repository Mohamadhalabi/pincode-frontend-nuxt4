...
import { a as useI18n, b as useRuntimeConfig, i as useState, d as useNuxtApp, g as asyncDataDefaults, h as createError } from './server.mjs';
...
function useAddedToast() {
  const s = useState("added-toast", () => ({ open: false, img: null, title: "", sku: null }));
  function show({ img, title, sku }) {
...
export { useApi as a, useAsyncData as b, refreshNuxtData as r, useAddedToast as u };
//# sourceMappingURL=useApi-KWNj2I5b.mjs.map
