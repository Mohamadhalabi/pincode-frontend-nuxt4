<template>
  <div class="max-w-4xl mx-auto px-4 py-10 sm:py-16">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-10 space-y-10 text-gray-700 leading-relaxed">
      <section>
        <h2 class="text-xl font-bold text-[#0e5e6f] mb-3">{{ $t('pages.privacy.sections.s1.title') }}</h2>
        <p>{{ $t('pages.privacy.sections.s1.body') }}</p>
      </section>

      <section>
        <h2 class="text-xl font-bold text-[#0e5e6f] mb-3">{{ $t('pages.privacy.sections.s2.title') }}</h2>
        <p>{{ $t('pages.privacy.sections.s2.body') }}</p>
      </section>

      <section>
        <h2 class="text-xl font-bold text-[#0e5e6f] mb-3">{{ $t('pages.privacy.sections.s3.title') }}</h2>
        <p>{{ $t('pages.privacy.sections.s3.body') }}</p>
      </section>

      <section>
        <h2 class="text-xl font-bold text-[#0e5e6f] mb-3">{{ $t('pages.privacy.sections.s4.title') }}</h2>
        <p>{{ $t('pages.privacy.sections.s4.body') }}</p>
      </section>

      <section>
        <h2 class="text-xl font-bold text-[#0e5e6f] mb-3">{{ $t('pages.privacy.sections.s5.title') }}</h2>
        <p>{{ $t('pages.privacy.sections.s5.body') }}</p>
      </section>
    </div>
  </div>
</template>
