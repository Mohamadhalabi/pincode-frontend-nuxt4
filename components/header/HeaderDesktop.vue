...
<template>
  ...
  <div class="h-24 flex items-center justify-between gap-4 relative z-50 px-4">
    ...
    <div class="flex-1 flex justify-start">
      <button class="flex items-center gap-2 group shrink-0" @click="emit('home')">
        <NuxtImg
          src="/img/logo/3.webp"
          alt="4Pincode"
    ...
    >
      ...
      <div class="relative group">
        ...
        <div class="absolute top-full left-0 w-64 pt-2 hidden group-hover:block z-50">
          <div class="bg-white border border-gray-200 rounded-lg shadow-xl py-1 overflow-hidden">
            <!-- Buy Old Tokens -->
            <button
              class="dropdown-item w-full text-left flex items-center gap-2"
              @click="emit('productsOld')"
            >
...
/* Icon Color on Hover (Solid Dark Teal) */
